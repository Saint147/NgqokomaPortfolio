  ...
  return (
    ...
    >
      ...
      <div className={`flex justify-center items-center md:items-start  px-10 md:px20 py-10 md:py-0 flex-col`}>
        <h2 className={`font-poppins font-semibold text-4xl text-white text-left`}>Let's connect to discuss your project today and discover how I breathe life into design through code!
                   
        </h2>
        <div className="flex gap-2 flex-col lg:flex-row my-4">
          <Button text="Contact Me" link="mailto:somelezengqokoma9@gmail.com" type="light"/>
